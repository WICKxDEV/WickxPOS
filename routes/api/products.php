...
Route::middleware( [
    NsRestrictMiddleware::arguments( 'wickxpos.delete.products' ),
] )->group( function () {
...
Route::post( 'products', [ ProductsController::class, 'saveProduct' ] )->middleware( NsRestrictMiddleware::arguments( 'wickxpos.create.products' ) );
Route::post( 'products/search', [ ProductsController::class, 'searchProduct' ] )->middleware( NsRestrictMiddleware::arguments( 'wickxpos.read.products' ) );
Route::post( 'products/adjustments', [ ProductsController::class, 'createAdjustment' ] )->middleware( NsRestrictMiddleware::arguments( 'wickxpos.update.products' ) );
Route::post( 'products/{identifier}/variations/{variation_id}', [ ProductsController::class, 'createSingleVariation' ] )->middleware( NsRestrictMiddleware::arguments( 'wickxpos.create.products' ) );
Route::post( 'products/{product}/units/conversion', [ ProductsController::class, 'convertUnits' ] )->middleware( NsRestrictMiddleware::arguments( 'wickxpos.update.products' ) );

Route::put( 'products/{identifier}/variations/{variation_id}', [ ProductsController::class, 'editSingleVariation' ] )->middleware( NsRestrictMiddleware::arguments( 'wickxpos.update.products' ) );
Route::put( 'products/{product}', [ ProductsController::class, 'updateProduct' ] )->middleware( NsRestrictMiddleware::arguments( 'wickxpos.update.products' ) );
