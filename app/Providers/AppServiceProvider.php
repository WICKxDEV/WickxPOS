...
class AppServiceProvider extends ServiceProvider
{
    ...
    {
        config( [ 'wickxpos.orders.statuses' => [
        ...
        config( [ 'wickxpos.orders.types' => Hook::filter( 'ns-orders-types', [
            'takeaway' => [
                'identifier' => 'takeaway',
                'label' => __( 'Take Away' ),
        ...
        config( [
            'wickxpos.orders.types-labels' => collect( config( 'wickxpos.orders.types' ) )
                ->mapWithKeys( fn( $type ) => [ $type[ 'identifier' ] => $type[ 'label' ] ] )
                ->toArray(),
        ] );

        config( [
            'wickxpos.orders.products.refunds' => [
