...
class Customer extends UserScope
{
    ...
    protected $table = 'wickxpos_' . 'users';
    ...
    protected static function booted()
    {
        static::addGlobalScope( 'customers', function ( Builder $builder ) {
            $role = DB::table( 'wickxpos_roles' )->where( 'namespace', Role::STORECUSTOMER )->first();

            $userRoleRelations = DB::table( 'wickxpos_users_roles_relations' )
