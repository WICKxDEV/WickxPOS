...
class ProductsController extends DashboardController
{
    ...
    {
        ns()->restrict( [ 'wickxpos.convert.products-units' ] );
    ...
    {
        ns()->restrict( [ 'wickxpos.update.products' ] );
    ...
    {
        ns()->restrict( [ 'wickxpos.create.products' ] );
    ...
    {
        ns()->restrict( [ 'wickxpos.delete.products-units', 'wickxpos.make.products-adjustments' ] );
    ...
    {
        ns()->restrict( [ 'wickxpos.make.products-adjustments' ] );
