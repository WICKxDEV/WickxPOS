        ...
        return SettingForm::tab(
            ...
            fields: SettingForm::fields(
                ...
                FormInput::select(
                    ...
                    options: Helper::kvToJsOptions( config( 'wickxpos.languages' ) ),
                    label: __( 'Language' ),
                ...
                FormInput::select(
                    ...
                    options: Helper::kvToJsOptions( config( 'wickxpos.themes' ) ),
                    label: __( 'Theme' ),
        ...
        return SettingForm::tab(
            ...
            fields: SettingForm::fields(
                ...
                FormInput::select(
                    ...
                    type: 'search-select',
                    options: Helper::kvToJsOptions( config( 'wickxpos.timezones' ) ),
