...
class UpdateCommand extends Command
{
     ...
     * @var string
     */
    protected $description = 'An utility for updating WickxPOS and it\'s modules. Only works if the project was installed using Git.';
    ...
    {
        // we need to update my.wickxpos.com to support this.
    }
