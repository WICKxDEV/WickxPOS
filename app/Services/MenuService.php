    ...
    public function buildMenus()
    {
        $this->menus = AsideMenu::wrapper(
            ...
            AsideMenu::menu(
                ...
                identifier: 'pos',
                permissions: [ 'wickxpos.create.orders' ],
            ...
            AsideMenu::menu(
                ...
                icon: 'la-photo-video',
                identifier: 'medias',
                permissions: [ 'wickxpos.upload.medias', 'wickxpos.see.medias' ],
            ...
            AsideMenu::menu(
                ...
                permissions: [
                    'wickxpos.read.providers',
                    'wickxpos.create.providers',
                ],
                childrens: AsideMenu::childrens(
                    AsideMenu::subMenu(
                        label: __( 'List' ),
                        identifier: 'providers',
                        permissions: [ 'wickxpos.read.providers' ],
                        href: ns()->url( '/dashboard/providers' )
                    ),
                    AsideMenu::subMenu(
                        label: __( 'Create A Provider' ),
                        identifier: 'create-provider',
                        permissions: [ 'wickxpos.create.providers' ],
            ...
            AsideMenu::menu(
                ...
                permissions: [
                    'wickxpos.read.transactions',
                    'wickxpos.create.transactions',
                    'wickxpos.read.transactions-account',
                    'wickxpos.create.transactions-account',
                ],
                childrens: AsideMenu::childrens(
                    AsideMenu::subMenu(
                        label: __( 'Expenses' ),
                        identifier: 'transactions',
                        permissions: [ 'wickxpos.read.transactions' ],
                        href: ns()->url( '/dashboard/accounting/transactions' )
                    ),
                    AsideMenu::subMenu(
                        label: __( 'Create Expense' ),
                        identifier: 'create-transaction',
                        permissions: [ 'wickxpos.create.transactions' ],
                        href: ns()->url( '/dashboard/accounting/transactions/create' )
                    ),
                    AsideMenu::subMenu(
                        label: __( 'Transaction History' ),
                        identifier: 'transactions-history',
                        permissions: [ 'wickxpos.read.transactions-history' ],
            ...
            AsideMenu::menu(
                ...
                permissions: [
                    'wickxpos.read.products',
                    'wickxpos.create.products',
                    'wickxpos.read.categories',
                    'wickxpos.create.categories',
                    'wickxpos.read.products-units',
                    'wickxpos.create.products-units',
                    'wickxpos.read.products-units',
                    'wickxpos.create.products-units',
                    'wickxpos.make.products-adjustments',
                ],
                childrens: AsideMenu::childrens(
                    AsideMenu::subMenu(
                        label: __( 'Products' ),
                        identifier: 'products',
                        permissions: [ 'wickxpos.read.products' ],
                        href: ns()->url( '/dashboard/products' )
                    ),
                    AsideMenu::subMenu(
                        label: __( 'Create Product' ),
                        identifier: 'create-products',
                        permissions: [ 'wickxpos.create.products' ],
                    ...
                    AsideMenu::subMenu(
                        ...
                        permissions: [ 'wickxpos.make.products-adjustments' ],
            ...
            AsideMenu::menu(
                ...
                identifier: 'reports',
                permissions: [
                    'wickxpos.reports.sales',
                    'wickxpos.reports.best_sales',
                    'wickxpos.reports.transactions',
                    'wickxpos.reports.yearly',
                    'wickxpos.reports.customers',
                    'wickxpos.reports.inventory',
                    'wickxpos.reports.payment-types',
                ],
                childrens: AsideMenu::childrens(
                    AsideMenu::subMenu(
                        label: __( 'Sale Report' ),
                        identifier: 'sales',
                        permissions: [ 'wickxpos.reports.sales' ],
                        href: ns()->url( '/dashboard/reports/sales' )
                    ),
                    AsideMenu::subMenu(
                        label: __( 'Sales Progress' ),
                        identifier: 'products-report',
                        permissions: [ 'wickxpos.reports.products-report' ],
                        href: ns()->url( '/dashboard/reports/sales-progress' )
                    ),
                    AsideMenu::subMenu(
                        label: __( 'Customers Statement' ),
                        identifier: 'customers-statement',
                        permissions: [ 'wickxpos.reports.customers-statement' ],
                        href: ns()->url( '/dashboard/reports/customers-statement' )
                    ),
                    AsideMenu::subMenu(
                        label: __( 'Stock Report' ),
                        identifier: 'low-stock',
                        permissions: [ 'wickxpos.reports.low-stock' ],
                        href: ns()->url( '/dashboard/reports/low-stock' )
                    ),
                    AsideMenu::subMenu(
                        label: __( 'Stock History' ),
                        identifier: 'stock-history',
                        permissions: [ 'wickxpos.reports.stock-history' ],
