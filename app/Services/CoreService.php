...
class CoreService
{
            ...
            if ( ! file_exists( public_path( 'modules/' . $tolowercase ) ) ) {
                ...
                if ( ! $notification instanceof Notification ) {
                    $notificationService->create(
                        ...
                        source: 'system',
                        url: 'https://my.wickxpos.com/en/documentation/troubleshooting/broken-media-images?utm_source=wickxpos&utm_campaign=warning&utm_medium=app',
                        description: sprintf(
    ...
    private function emitCronMisconfigurationNotification(): void
    {
        ...
        $notification->create(
            ...
            source: 'system',
            url: 'https://my.wickxpos.com/en/documentation/troubleshooting/workers-or-async-requests-disabled?utm_source=wickxpos&utm_campaign=warning&utm_medium=app',
            description: __( "Cron jobs aren't configured correctly on WickxPOS. This might restrict necessary features. Click here to learn how to fix it." ),
        )->dispatchForGroup( Role::namespace( Role::ADMIN ) );
    }
    ...
    private function emitNotificationForTaskSchedulingMisconfigured(): void
    {
        ...
        $notification->create(
            ...
            source: 'system',
            url: 'https://my.wickxpos.com/en/documentation/troubleshooting/workers-or-async-requests-disabled?utm_source=wickxpos&utm_campaign=warning&utm_medium=app',
            description: __( 'WickxPOS is unable to schedule background tasks. This might restrict necessary features. Click here to learn how to fix it.' ),
        )->dispatchForGroup( Role::namespace( Role::ADMIN ) );
    }
