...
class TaxesGroupCrud extends CrudService
{
     ...
     */
    protected $table = 'wickxpos_taxes_groups';
     ...
     */
    public $relations = [
        [ 'wickxpos_users as user', 'wickxpos_taxes_groups.author', '=', 'user.id' ],
    ];
    ...
    protected $permissions = [
        'create' => 'wickxpos.create.taxes',
        'read' => 'wickxpos.read.taxes',
        'update' => 'wickxpos.update.taxes',
        'delete' => 'wickxpos.delete.taxes',
    ];
