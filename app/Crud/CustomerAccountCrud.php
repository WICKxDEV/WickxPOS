...
class CustomerAccountCrud extends CrudService
{
     ...
     * @param  string
     */
    protected $table = 'wickxpos_customers_account_history';
    ...
    protected $permissions = [
        'create' => 'wickxpos.customers.manage-account-history',
        'read' => 'wickxpos.customers.manage-account-history',
        'update' => 'wickxpos.customers.manage-account-history',
        'delete' => 'wickxpos.customers.manage-account-history',
    ];
    ...
    /**
     * Adding relation
     * Example : [ 'wickxpos_users as user', 'user.id', '=', 'wickxpos_orders.author' ]
     *
     * @param  array
     */
    public $relations = [
        [ 'wickxpos_users as user', 'user.id', '=', 'wickxpos_customers_account_history.author' ],
        'leftJoin' => [
            [ 'wickxpos_orders as order', 'order.id', '=', 'wickxpos_customers_account_history.order_id' ],
        ],
    ];
     ...
     * Example : [
     *      'user'  =>  [ 'username' ], // here the relation on the table wickxpos_users is using "user" as an alias
     * ]
     */
    public $pick = [
        'order' => [ 'code' ],
    ...
    public function __construct()
    {
        ...
        $this->queryFilters = [
            [
                ...
                'name' => 'wickxpos_customers_account_history.created_at',
                ...
                'type' => 'select',
                'label' => __( 'Author' ),
                'name' => 'wickxpos_customers_account_history.author',
    ...
    public function hook( $query ): void
    {
        ...
        $query->where( Hook::filter( 'ns-model-table', 'wickxpos_customers_account_history.customer_id' ), request()->query( 'customer_id' ) );
    }
