...
class CustomerGroupCrud extends CrudService
{
     ...
     */
    protected $table = 'wickxpos_customers_groups';
     ...
     */
    public $relations = [
        [ 'wickxpos_users', 'wickxpos_customers_groups.author', '=', 'wickxpos_users.id' ],
        'leftJoin' => [
            [ 'wickxpos_rewards_system as reward', 'reward.id', '=', 'wickxpos_customers_groups.reward_system_id' ],
        ],
    ];

    public $pick = [
        'wickxpos_users' => [ 'username' ],
        'reward' => [ 'name' ],
    ];
    ...
    protected $permissions = [
        'create' => 'wickxpos.create.customers-groups',
        'read' => 'wickxpos.read.customers-groups',
        'update' => 'wickxpos.update.customers-groups',
        'delete' => 'wickxpos.delete.customers-groups',
    ];
    ...
    public function getColumns(): array
    {
        return CrudTable::columns(
            ...
            CrudTable::column( __( 'Author' ), 'wickxpos_users_username' ),
