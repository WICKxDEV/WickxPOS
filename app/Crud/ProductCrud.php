...
class ProductCrud extends CrudService
{
     ...
     */
    protected $table = 'wickxpos_products';
     ...
     */
    public $relations = [
        [ 'wickxpos_users as user', 'wickxpos_products.author', '=', 'user.id' ],
        'leftJoin' => [
            [ 'wickxpos_products_categories as category', 'wickxpos_products.category_id', '=', 'category.id' ],
            [ 'wickxpos_products as parent', 'wickxpos_products.parent_id', '=', 'parent.id' ],
            [ 'wickxpos_taxes_groups as taxes_groups', 'wickxpos_products.tax_group_id', '=', 'taxes_groups.id' ],
        ],
    ];
    ...
    protected $permissions = [
        'create' => 'wickxpos.create.products',
        'read' => 'wickxpos.read.products',
        'update' => 'wickxpos.update.products',
        'delete' => 'wickxpos.delete.products',
    ];
