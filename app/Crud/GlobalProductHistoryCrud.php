...
class GlobalProductHistoryCrud extends CrudService
{
     ...
     * @param  string
     */
    protected $table = 'wickxpos_products_histories';
     ...
     */
    public $relations = [
        [ 'wickxpos_users as user', 'user.id', '=', 'wickxpos_products_histories.author' ],
        [ 'wickxpos_products as product', 'product.id', '=', 'wickxpos_products_histories.product_id' ],
        [ 'wickxpos_units as unit', 'unit.id', '=', 'wickxpos_products_histories.unit_id' ],
        'leftJoin' => [
            [ 'wickxpos_procurements as procurement', 'procurement.id', '=', 'wickxpos_products_histories.procurement_id' ],
            [ 'wickxpos_orders as order', 'order.id', '=', 'wickxpos_products_histories.order_id' ],
        ],
    ];
