...
class TransactionCrud extends CrudService
{
     ...
     */
    protected $table = 'wickxpos_transactions';
     ...
     */
    public $relations = [
        [ 'wickxpos_users as user', 'wickxpos_transactions.author', '=', 'user.id' ],
        [ 'wickxpos_transactions_accounts as transactions_accounts', 'transactions_accounts.id', '=', 'wickxpos_transactions.account_id' ],
    ];
    ...
    protected $permissions = [
        'create' => 'wickxpos.create.transactions',
        'read' => 'wickxpos.read.transactions',
        'update' => 'wickxpos.update.transactions',
        'delete' => 'wickxpos.delete.transactions',
    ];
