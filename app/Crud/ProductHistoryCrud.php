...
class ProductHistoryCrud extends CrudService
{
    ...
    protected $permissions = [
        'create' => false,
        'read' => 'wickxpos.read.products-history',
        'update' => false,
        'delete' => false,
    ];
     ...
     */
    public $relations = [
        [ 'wickxpos_products as products', 'wickxpos_products_histories.product_id', '=', 'products.id' ],
        [ 'wickxpos_units as units', 'wickxpos_products_histories.unit_id', '=', 'units.id' ],
        'leftJoin' => [
            [ 'wickxpos_users as users', 'wickxpos_products_histories.author', '=', 'users.id' ],
            [ 'wickxpos_procurements as procurements', 'wickxpos_products_histories.procurement_id', '=', 'procurements.id' ],
            [ 'wickxpos_orders as orders', 'wickxpos_products_histories.order_id', '=', 'orders.id' ],
        ],
    ];
