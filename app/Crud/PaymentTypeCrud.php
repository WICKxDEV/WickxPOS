...
class PaymentTypeCrud extends CrudService
{
     ...
     * @param  string
     */
    protected $table = 'wickxpos_payments_types';
    ...
    protected $permissions = [
        'create' => 'wickxpos.manage-payments-types',
        'read' => 'wickxpos.manage-payments-types',
        'update' => 'wickxpos.manage-payments-types',
        'delete' => 'wickxpos.manage-payments-types',
    ];
     ...
     */
    public $relations = [
        [ 'wickxpos_users as user', 'user.id', '=', 'wickxpos_payments_types.author' ],
    ];
    ...
    public function beforePost( $request )
    {
        ...
        Cache::forget( 'wickxpos.pos.payments' );
        Cache::forget( 'wickxpos.pos.payments-key' );
