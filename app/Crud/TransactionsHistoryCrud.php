...
class TransactionsHistoryCrud extends CrudService
{
     ...
     * @param string
     */
    protected $table = 'wickxpos_transactions_histories';
    ...
    protected $permissions = [
        'create' => false,
        'read' => 'wickxpos.read.transactions-history',
        'update' => false,
        'delete' => 'wickxpos.delete.transactions-history',
    ];
    ...
    public $relations = [
        'leftJoin' => [
            [ 'wickxpos_transactions as transaction', 'transaction.id', '=', 'wickxpos_transactions_histories.transaction_id' ],
        ],
        [ 'wickxpos_users as users', 'users.id', '=', 'wickxpos_transactions_histories.author' ],
        [ 'wickxpos_transactions_accounts as transactions_accounts', 'transactions_accounts.id', '=', 'wickxpos_transactions_histories.transaction_account_id' ],
    ];
