...
class CouponCrud extends CrudService
{
     ...
     * @param  string
     */
    protected $table = 'wickxpos_coupons';
    ...
    protected $permissions = [
        'create' => 'wickxpos.create.coupons',
     ...
     */
    public $relations = [
        [ 'wickxpos_users', 'wickxpos_coupons.author', '=', 'wickxpos_users.id' ],
    ];
                ...
                CrudForm::tab(
                    ...
                    fields: CrudForm::fields(
                        FormInput::text(
                            ...
                            validation: [
                                'required',
                                Rule::unique( 'wickxpos_coupons', 'code' )->ignore( $entry !== null ? $entry->id : 0 ),
                            ],
