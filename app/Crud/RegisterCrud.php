...
class RegisterCrud extends CrudService
{
     ...
     * @param  string
     */
    protected $table = 'wickxpos_registers';
    ...
    protected $permissions = [
        'create' => 'wickxpos.create.registers',
        'read' => 'wickxpos.read.registers',
        'update' => 'wickxpos.update.registers',
        'delete' => 'wickxpos.delete.registers',
    ];
     ...
     */
    public $relations = [
        [ 'wickxpos_users as user', 'wickxpos_registers.author', '=', 'user.id' ],
        'leftJoin' => [
            [ 'wickxpos_users as cashier', 'wickxpos_registers.used_by', '=', 'cashier.id' ],
        ],
    ];
