...
class ProductCategoryCrud extends CrudService
{
     ...
     */
    protected $table = 'wickxpos_products_categories';
     ...
     */
    public $relations = [
        [ 'wickxpos_users as user', 'wickxpos_products_categories.author', '=', 'user.id' ],
        'leftJoin' => [
            [ 'wickxpos_products_categories as parent', 'wickxpos_products_categories.parent_id', '=', 'parent.id' ],
        ],
    ];
    ...
    protected $permissions = [
        'create' => 'wickxpos.create.categories',
        'read' => 'wickxpos.read.categories',
        'update' => 'wickxpos.update.categories',
        'delete' => 'wickxpos.delete.categories',
    ];
