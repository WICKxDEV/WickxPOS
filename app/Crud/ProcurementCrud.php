...
class ProcurementCrud extends CrudService
{
     ...
     */
    protected $table = 'wickxpos_procurements';
     ...
     */
    public $relations = [
        [ 'wickxpos_users as users', 'wickxpos_procurements.author', '=', 'users.id' ],
        [ 'wickxpos_providers as providers', 'wickxpos_procurements.provider_id', '=', 'providers.id' ],
    ];
     ...
     */
    public $permissions = [
        'create' => 'wickxpos.create.procurements',
        'read' => 'wickxpos.read.procurements',
        'update' => false,
        'delete' => 'wickxpos.delete.procurements',
    ];
