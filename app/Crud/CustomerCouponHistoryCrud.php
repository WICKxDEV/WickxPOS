...
class CustomerCouponHistoryCrud extends CrudService
{
     ...
     * @param string
     */
    protected $table = 'wickxpos_orders_coupons';
     ...
     */
    public $relations = [
        [ 'wickxpos_orders as order', 'order.id', '=', 'wickxpos_orders_coupons.order_id' ],
        [ 'wickxpos_coupons as coupon', 'coupon.id', '=', 'wickxpos_orders_coupons.coupon_id' ],
        [ 'wickxpos_users as user', 'user.id', '=', 'wickxpos_orders_coupons.author' ],
    ];
