...
class TaxCrud extends CrudService
{
     ...
     * @param  string
     */
    protected $table = 'wickxpos_taxes';
    ...
    public $relations = [
        [ 'wickxpos_users as user', 'wickxpos_taxes.author', '=', 'user.id' ],
        [ 'wickxpos_taxes_groups as parent', 'wickxpos_taxes.tax_group_id', '=', 'parent.id' ],
    ];
