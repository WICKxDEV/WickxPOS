...
class RewardSystemCrud extends CrudService
{
     ...
     */
    protected $table = 'wickxpos_rewards_system';
     ...
     */
    public $relations = [
        [ 'wickxpos_users', 'wickxpos_rewards_system.author', '=', 'wickxpos_users.id' ],
        [ 'wickxpos_coupons as coupon', 'coupon.id', '=', 'wickxpos_rewards_system.coupon_id' ],
    ];
    ...
    protected $permissions = [
        'create' => 'wickxpos.create.rewards',
        'read' => 'wickxpos.read.rewards',
        'update' => 'wickxpos.update.rewards',
        'delete' => 'wickxpos.delete.rewards',
    ];
