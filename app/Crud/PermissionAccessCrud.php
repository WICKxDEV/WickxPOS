...
class PermissionAccessCrud extends CrudService
{
     ...
     * @param string
     */
    protected $table = 'wickxpos_permissions_access';
     ...
     * public $relations = [
     *  'leftJoin' => [
     *      [ 'wickxpos_users as user', 'user.id', '=', 'wickxpos_orders.author' ]
     *  ]
     * ];
     *
     * @param array
    ...
    public $relations = [
        'leftJoin' => [
            [ 'wickxpos_users as requester', 'requester.id', '=', 'wickxpos_permissions_access.requester_id' ],
            [ 'wickxpos_users as granter', 'granter.id', '=', 'wickxpos_permissions_access.granter_id' ],
        ],
    ];
