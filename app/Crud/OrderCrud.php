...
class OrderCrud extends CrudService
{
     ...
     */
    protected $table = 'wickxpos_orders';
     ...
     */
    public $relations = [
        [ 'wickxpos_users as author', 'wickxpos_orders.author', '=', 'author.id' ],
        [ 'wickxpos_users as customer', 'wickxpos_orders.customer_id', '=', 'customer.id' ],
    ];
    ...
    protected $permissions = [
        'create' => 'wickxpos.create.orders',
        'read' => 'wickxpos.read.orders',
        'update' => 'wickxpos.update.orders',
        'delete' => 'wickxpos.delete.orders',
    ];
    ...
    public function __construct()
    {
        ...
        $this->queryFilters = [
            [
                ...
                'name' => 'wickxpos_orders.created_at',
    ...
    public function setActions( CrudEntry $entry ): CrudEntry
    {
         ...
         */
        $refundCount = DB::table( Hook::filter( 'ns-model-table', 'wickxpos_orders_refunds' ) )
