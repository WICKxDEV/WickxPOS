...
class CustomerCouponCrud extends CrudService
{
     ...
     * @param  string
     */
    protected $table = 'wickxpos_customers_coupons';
    ...
    protected $permissions = [
        'create' => false,
        'read' => 'wickxpos.read.coupons',
        'update' => 'wickxpos.update.coupons',
        'delete' => 'wickxpos.delete.coupons',
    ];
    ...
    public $relations = [
        'leftJoin' => [
            [ 'wickxpos_users as user', 'user.id', '=', 'wickxpos_customers_coupons.author' ],
        ],
        [ 'wickxpos_users as customer', 'customer.id', '=', 'wickxpos_customers_coupons.customer_id' ],
        [ 'wickxpos_coupons as coupon', 'coupon.id', '=', 'wickxpos_customers_coupons.coupon_id' ],
    ];
