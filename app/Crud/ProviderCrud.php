...
class ProviderCrud extends CrudService
{
     ...
     */
    protected $table = 'wickxpos_providers';
     ...
     */
    public $relations = [
        [ 'wickxpos_users', 'wickxpos_users.id', '=', 'wickxpos_providers.author' ],
    ];
    ...
    protected $permissions = [
        'create' => 'wickxpos.create.providers',
        'read' => 'wickxpos.read.providers',
        'update' => 'wickxpos.update.providers',
        'delete' => 'wickxpos.delete.providers',
    ];
