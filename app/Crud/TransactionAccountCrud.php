...
class TransactionAccountCrud extends CrudService
{
     ...
     */
    protected $table = 'wickxpos_transactions_accounts';
     ...
     */
    public $relations = [
        [ 'wickxpos_users', 'wickxpos_transactions_accounts.author', '=', 'wickxpos_users.id' ],
        'leftJoin' => [
            [ 'wickxpos_transactions_accounts as subaccount', 'subaccount.id', '=', 'wickxpos_transactions_accounts.sub_category_id' ],
        ],
    ];
    ...
    protected $permissions = [
        'create' => 'wickxpos.create.transactions-account',
        'read' => 'wickxpos.read.transactions-account',
        'update' => 'wickxpos.update.transactions-account',
        'delete' => 'wickxpos.delete.transactions-account',
    ];
    ...
    public function getColumns(): array
    {
        return CrudTable::columns(
            ...
            CrudTable::column(
                label: __( 'Author' ),
                identifier: 'wickxpos_users_username',
            ),
            CrudTable::column(
                label: __( 'Created At' ),
