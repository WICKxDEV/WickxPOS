...
class ProductUnitQuantitiesCrud extends CrudService
{
     ...
     */
    protected $table = 'wickxpos_products_unit_quantities';
     ...
     */
    public $relations = [
        [ 'wickxpos_products as products', 'products.id', '=', 'wickxpos_products_unit_quantities.product_id' ],
        [ 'wickxpos_units as units', 'units.id', '=', 'wickxpos_products_unit_quantities.unit_id' ],
    ];
