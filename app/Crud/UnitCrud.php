...
class UnitCrud extends CrudService
{
     ...
     */
    protected $table = 'wickxpos_units';
     ...
     */
    public $relations = [
        [ 'wickxpos_users as user', 'wickxpos_units.author', '=', 'user.id' ],
        [ 'wickxpos_units_groups as group', 'wickxpos_units.group_id', '=', 'group.id' ],
    ];
    ...
    protected $permissions = [
        'create' => 'wickxpos.create.products-units',
        'read' => 'wickxpos.read.products-units',
        'update' => 'wickxpos.update.products-units',
        'delete' => 'wickxpos.delete.products-units',
    ];
                ...
                CrudForm::tab(
                    ...
                    fields: CrudForm::fields(
                        FormInput::text(
                            ...
                            validation: 'unique:' . Hook::filter( 'ns-table-name', 'wickxpos_units' ) . ',identifier' . ( $entry !== null ? ',' . $entry->id : '' ),
