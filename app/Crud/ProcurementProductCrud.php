...
class ProcurementProductCrud extends CrudService
{
     ...
     * @param  string
     */
    protected $table = 'wickxpos_procurements_products';
     ...
     */
    public $relations = [
        [ 'wickxpos_procurements as procurement', 'procurement.id', '=', 'wickxpos_procurements_products.procurement_id' ],
        [ 'wickxpos_units as unit', 'unit.id', '=', 'wickxpos_procurements_products.unit_id' ],
        [ 'wickxpos_users as user', 'user.id', '=', 'wickxpos_procurements_products.author' ],
    ];
