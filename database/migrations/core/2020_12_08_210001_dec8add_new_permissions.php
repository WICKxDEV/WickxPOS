...
return new class extends Migration
{
    ...
    public function up()
    {
        $readHistory = Permission::withNamespaceOrNew( 'wickxpos.read.cash-flow-history' );
        $readHistory->name = __( 'Read Cash Flow History' );
        $readHistory->namespace = 'wickxpos.read.cash-flow-history';
        $readHistory->description = __( 'Allow to the Cash Flow History.' );
        $readHistory->save();

        $deleteHistory = Permission::withNamespaceOrNew( 'wickxpos.delete.cash-flow-history' );
        $deleteHistory->name = __( 'Delete Expense History' );
        $deleteHistory->namespace = 'wickxpos.delete.cash-flow-history';
