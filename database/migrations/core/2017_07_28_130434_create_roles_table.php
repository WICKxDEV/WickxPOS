...
return new class extends Migration
{
    ...
    public function up()
    {
        if ( ! Schema::hasTable( 'wickxpos_roles' ) ) {
            Schema::create( 'wickxpos_roles', function ( Blueprint $table ) {
                $table->increments( 'id' );
        ...
        if ( ! Schema::hasTable( 'wickxpos_role_permission' ) ) {
            Schema::create( 'wickxpos_role_permission', function ( Blueprint $table ) {
    ...
    {
        Schema::dropIfExists( 'wickxpos_roles' );
        Schema::dropIfExists( 'wickxpos_role_permission' );
    }
};
