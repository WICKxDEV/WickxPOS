...
return new class extends Migration
{
    ...
    private $permission = 'wickxpos.customers.manage-account-history';
    ...
    public function up()
    {
        ...
        Role::namespace( 'wickxpos.store.administrator' )->addPermissions( $this->permission );
        Role::namespace( 'wickxpos.store.cashier' )->addPermissions( $this->permission );
    }
