...
return new class extends Migration
{
    ...
    public function up()
    {
        if ( ! Schema::hasTable( 'wickxpos_orders_coupons' ) ) {
            Schema::createIfMissing( 'wickxpos_orders_coupons', function ( Blueprint $table ) {
    ...
    {
        if ( Schema::hasTable( 'wickxpos_orders_coupons' ) ) {
            Schema::dropIfExists( 'wickxpos_orders_coupons' );
        }
    }
};
