...
return new class extends Migration
{
    ...
    public function up()
    {
        if ( ! Schema::hasTable( 'wickxpos_procurements_products' ) ) {
            Schema::createIfMissing( 'wickxpos_procurements_products', function ( Blueprint $table ) {
    ...
    {
        if ( Schema::hasTable( 'wickxpos_procurements_products' ) ) {
            Schema::dropIfExists( 'wickxpos_procurements_products' );
        }
    }
};
