...
return new class extends Migration
{
    ...
    {
        if ( ! Schema::hasTable( 'wickxpos_permissions_access' ) ) {
            Schema::create( 'wickxpos_permissions_access', function ( Blueprint $table ) {
                $table->id();
    ...
    {
        Schema::dropIfExists( 'wickxpos_permissions_access' );
    }
};
