...
return new class extends Migration
{
    ...
    public function up()
    {
        if ( ! Schema::hasTable( 'wickxpos_procurements' ) ) {
            Schema::createIfMissing( 'wickxpos_procurements', function ( Blueprint $table ) {
    ...
    {
        if ( Schema::hasTable( 'wickxpos_procurements' ) ) {
            Schema::dropIfExists( 'wickxpos_procurements' );
        }
    }
};
