...
return new class extends Migration
{
    ...
    public function up()
    {
        if ( ! Schema::hasTable( 'wickxpos_orders' ) ) {
            Schema::createIfMissing( 'wickxpos_orders', function ( Blueprint $table ) {
        ...
        if ( ! Schema::hasTable( 'wickxpos_orders_count' ) ) {
            Schema::createIfMissing( 'wickxpos_orders_count', function ( Blueprint $table ) {
                $table->bigIncrements( 'id' );
                $table->integer( 'count' );
                $table->datetime( 'date' );
            } );
        ...
        if ( ! Schema::hasTable( 'wickxpos_orders_taxes' ) ) {
            Schema::createIfMissing( 'wickxpos_orders_taxes', function ( Blueprint $table ) {
                $table->bigIncrements( 'id' );
    ...
    {
        if ( Schema::hasTable( 'wickxpos_orders' ) ) {
            Schema::dropIfExists( 'wickxpos_orders' );
        }

        if ( Schema::hasTable( 'wickxpos_orders_count' ) ) {
            Schema::dropIfExists( 'wickxpos_orders_count' );
        }

        if ( Schema::hasTable( 'wickxpos_orders_taxes' ) ) {
            Schema::dropIfExists( 'wickxpos_orders_taxes' );
        }
    }
};
