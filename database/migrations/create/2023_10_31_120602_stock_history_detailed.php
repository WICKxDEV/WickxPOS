...
return new class extends Migration
{
    ...
    {
        if ( ! Schema::hasTable( 'wickxpos_products_histories_combined' ) ) {
            Schema::create( 'wickxpos_products_histories_combined', function ( Blueprint $table ) {
                $table->increments( 'id' );
                $table->string( 'name' );
                $table->date( 'date' );
    ...
    {
        Schema::dropIfExists( 'wickxpos_products_histories_combined' );
    }
};
