...
return new class extends Migration
{
    ...
    public function up()
    {
        if ( ! Schema::hasTable( 'wickxpos_orders_products' ) ) {
            Schema::createIfMissing( 'wickxpos_orders_products', function ( Blueprint $table ) {
    ...
    {
        if ( Schema::hasTable( 'wickxpos_orders_products' ) ) {
            Schema::dropIfExists( 'wickxpos_orders_products' );
        }
    }
};
