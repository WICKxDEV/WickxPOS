...
return new class extends Migration
{
    ...
    public function up()
    {
        if ( ! Schema::hasTable( 'wickxpos_products_unit_quantities' ) ) {
            Schema::createIfMissing( 'wickxpos_products_unit_quantities', function ( Blueprint $table ) {
    ...
    {
        if ( Schema::hasTable( 'wickxpos_products_unit_quantities' ) ) {
            Schema::dropIfExists( 'wickxpos_products_unit_quantities' );
        }
    }
};
