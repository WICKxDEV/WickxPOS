...
return new class extends Migration
{
    ...
    public function up()
    {
        if ( ! Schema::hasTable( 'wickxpos_products_histories' ) ) {
            Schema::createIfMissing( 'wickxpos_products_histories', function ( Blueprint $table ) {
    ...
    {
        if ( Schema::hasTable( 'wickxpos_products_histories' ) ) {
            Schema::dropIfExists( 'wickxpos_products_histories' );
        }
    }
};
