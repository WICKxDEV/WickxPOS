...
<div id="pos-app" class="h-full w-full relative">
    <div id="loader" class="top-0 anim-duration-500 fade-in-entrance left-0 absolute w-full z-50 h-full flex flex-col items-center justify-center">
        ...
        @else
        <img src="{{ asset( 'svg/wickxpos-variant-1.svg' ) }}" class="w-32" alt="POS">
        @endif
...
@section( 'layout.dashboard.footer' )
    ...
    document.addEventListener( 'DOMContentLoaded', () => {
        ...
        POS.defineSettings({
            barcode_search          :   true,
            text_search             :   false,
            edit_purchase_price     :   <?php echo Gate::allows( 'wickxpos.pos.edit-purchase-price' ) ? 'true' : 'false';?>,
            edit_settings           :   <?php echo Gate::allows( 'wickxpos.pos.edit-settings' ) ? 'true' : 'false';?>,
            products_discount       :   <?php echo Gate::allows( 'wickxpos.pos.products-discount' ) ? 'true' : 'false';?>,
            cart_discount           :   <?php echo Gate::allows( 'wickxpos.pos.cart-discount' ) ? 'true' : 'false';?>,
            breadcrumb              :   [],
            products_queue          :   [],
