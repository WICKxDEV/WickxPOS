...
export default {
    ...
    methods: {
        ...
        async openAddQuickProduct() {
             ...
             */
            await ActionPermissions.canProceed( 'wickxpos.cart.products' );
        ...
        async changeProductPrice( product ) {
            ...
            if ( this.settings.unit_price_editable ) {
                try {
                     ...
                     */
                    await ActionPermissions.canProceed( 'wickxpos.cart.product-price' );
        ...
        async selectCoupon() {
             ...
             */
            await ActionPermissions.canProceed( 'wickxpos.cart.coupons' );
        ...
        async openNotePopup() {
             ...
             */
            await ActionPermissions.canProceed( 'wickxpos.cart.comments' );
        ...
        async selectTaxGroup( activeTab = 'settings' ) {
             ...
             */
            await ActionPermissions.canProceed( 'wickxpos.cart.taxes' );
        ...
        async openDiscountPopup( reference, type, index = null ) {
            ...
            await ActionPermissions.canProceed( type === 'product' ? 'wickxpos.cart.product-discount' : 'wickxpos.cart.discount' );
        ...
        async toggleMode( product, index ) {
            ...
            if ( product.mode === 'normal' ) {
                 ...
                 */
                await ActionPermissions.canProceed( 'wickxpos.cart.product-wholesale-price' );
        ...
        async removeUsingIndex( index ) {
             ...
             */
            await ActionPermissions.canProceed( 'wickxpos.cart.product-delete' );
