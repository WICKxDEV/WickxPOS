<template>
    <div id="ns-pos-customers" class="shadow-lg rounded-lg w-[95vw] h-[95vh] lg:w-[60vw] flex flex-col overflow-hidden">
        ...
        <div class="ns-body flex-auto flex p-2 overflow-y-auto">
            <ns-tabs :active="activeTab" @active="activeTab = $event">
                <ns-tabs-item identifier="create-customers" :label="__( 'New Customer' )">
                    <ns-crud-form
                        v-if="userCan( 'wickxpos.create.customers' )"
                    ...
                    <div v-if="! userCan( 'wickxpos.create.customers' )" class="h-full flex-col w-full flex items-center justify-center text-font">
