[![Latest Stable Version](https://poser.pugx.org/blair2004/wickxpos/v)](//packagist.org/packages/blair2004/wickxpos) [![Total Downloads](https://poser.pugx.org/blair2004/wickxpos/downloads)](//packagist.org/packages/blair2004/wickxpos) [![Latest Unstable Version](https://poser.pugx.org/blair2004/wickxpos/v/unstable)](//packagist.org/packages/blair2004/wickxpos) [![License](https://poser.pugx.org/blair2004/wickxpos/license)](//packagist.org/packages/blair2004/wickxpos)

<p align="center">
  <img src="https://user-images.githubusercontent.com/5265663/162700085-40ed00ca-9154-42cb-850a-ccf1c2db2d5d.png" alt="NexoPOS"/>
</p>

WickxPOS 4 is a free point-of-sale system built using Laravel, TailwindCSS, Vue, and other open-source resources. This POS System focuses on utilities and functionalities to offer for most businesses all the tools they need to better manage their store. NexoPOS includes a responsive and beautiful dashboard that ease the interaction either on a smartphone, tablet, or desktop.

Read Review On:
[![Laravel News](https://user-images.githubusercontent.com/5265663/186377311-c42ddd2c-bc84-465c-a3b6-94e6df8d68bc.jpg)](https://laravel-news.com/wickxpos-point-of-sale-for-laravel?utm_source=github.com&utm_medium=readme&utm_campagin=wickxpos)

## Demo
Now you can create demo instances on [WickxPOS Cloud](https://cloud.wickxpos.com).
...
## Documentation
All the documentation for NexoPOS can be found on [My NexoPOS](https://my.wickxpos.com/en/documentation). That includes : 

- [Configuring the environment](https://my.wickxpos.com/en/documentation/getting-started/configuring-the-environment)
- [Downloading NexoPOS](https://my.wickxpos.com/en/documentation/getting-started/download-and-install)
- [Installing NexoPOS](https://my.wickxpos.com/en/documentation/getting-started/installation-wizard)
- [Rest API](https://docs.api.wickxpos.com)

And for developers, there are more technical tutorials that cover:
- [Creating a module](https://my.wickxpos.com/en/documentation/developpers-guides/how-to-create-a-module-for-wickxpos-4-x)
- [Create a menu for a module](https://my.wickxpos.com/en/documentation/developpers-guides/how-to-create-a-menu-on-wickxpos-4-x)
- [Create a route](https://my.wickxpos.com/en/documentation/developpers-guides/how-to-register-routes-for-modules)
...
NexoPOS available on [CodeCanyon](https://codecanyon.net/item/wickxpos-4x-pos-crm-inventory-manager/31188619) gives access to the premium modules marketplace. While purchasing on CodeCanyon, you get : 

- $40 In credit to [My NexoPOS](https://my.wickxpos.com/en/marketplace) balance.
...
2 - If you would like to have dedicated support. Consider registering as a member to [My NexoPOS platform](https://my.wickxpos.com/en/account/checkout/premium).
