...
The concern should priorily be reported to `contact@wickxpos.com`. We'll usually reply once we receive a report and we'll also share either the commit or the version to test the most recent version with the fix.
